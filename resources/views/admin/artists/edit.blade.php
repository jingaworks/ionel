    ...
    <div class="card-body">
        <form method="POST" action="{{ route("admin.artists.update", [$artist->id]) }}" enctype="multipart/form-data">
            ...
            <div class="form-group">
                <label for="slug">{{ trans('cruds.artist.fields.slug') }}</label>
                <input class="form-control {{ $errors->has('slug') ? 'is-invalid' : '' }}" type="text" name="slug" id="slug" value="{{ old('slug', $artist->slug) }}">
                @if($errors->has('slug'))
                    <div class="invalid-feedback">
                        {{ $errors->first('slug') }}
                    </div>
                @endif
                <span class="help-block">{{ trans('cruds.artist.fields.slug_helper') }}</span>
            </div>
            <div class="form-group">
            ...
            <div class="form-group">
                <label for="image">{{ trans('cruds.artist.fields.image') }}</label>
                ...
                @endif
                <span class="help-block">{{ trans('cruds.artist.fields.image_helper') }}</span>
            </div>
            <div class="form-group">
...
@if(isset($artist) && $artist->image)
      var file = {!! json_encode($artist->image) !!}
